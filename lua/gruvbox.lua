...
local function get_groups()
  ...
  local groups = {
    ...
    NormalFloat = config.transparent_mode and { fg = colors.fg1, bg = nil } or { fg = colors.fg1, bg = colors.bg2 },
    FloatBorder = config.transparent_mode and { fg = colors.fg1, bg = nil } or { fg = colors.fg1, bg = colors.bg2 },
    ...
    IlluminatedWordText = { underline = config.underline },
    IlluminatedWordRead = { underline = config.underline },
    IlluminatedWordWrite = { underline = config.underline },
    ...
    TroubleCount = { bg = colors.bg0 },
    TroubleFoldIcon = { bg = colors.bg0 },
    TermutilsFloat = { link = "GruvboxFg2" },
    TermutilsBorder = { link = "GruvboxFg4" },
